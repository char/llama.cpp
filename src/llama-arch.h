...
enum llm_kv {
    ...
    LLM_KV_ENCODER_ATTENTION_HEAD_COUNT_KV,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ENC_FFN_GATE_INP,
    LLM_TENSOR_ENC_FFN_GATE_EXPS,
    LLM_TENSOR_ENC_FFN_DOWN_EXPS,
    LLM_TENSOR_ENC_FFN_UP_EXPS,
    LLM_TENSOR_ENC_EXP_PROBS_B,
    LLM_TENSOR_ENC_FFN_OUTPUT_B,
    LLM_TENSOR_DEC_FFN_GATE_INP,
    LLM_TENSOR_DEC_FFN_GATE_EXPS,
    LLM_TENSOR_DEC_FFN_DOWN_EXPS,
    LLM_TENSOR_DEC_FFN_UP_EXPS,
    LLM_TENSOR_DEC_EXP_PROBS_B,
    LLM_TENSOR_DEC_FFN_OUTPUT_B,
    LLM_TENSOR_CLS,
    LLM_TENSOR_CLS_OUT,
    LLM_TENSOR_CLS_NORM,
    LLM_TENSOR_CONV1D,
